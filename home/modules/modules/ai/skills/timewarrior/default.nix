{
  ...
  cfg = config.modules.ai.skills.timewarrior;
in {
  options.modules.ai.skills.timewarrior = {
  ...
  config = mkIf cfg.enable {
    modules.ai.agents = {
      ...
      github-copilot-cli.settings.resources = [
        "skill://${config.home.homeDirectory}/.copilot/skills/timewarrior-efficient-entry"
      ];
    };
    ...
    xdg.configFile = {
      "opencode/skill/timewarrior-efficient-entry".source = "${cfg.package}/skills/timewarrior-efficient-entry";
      ".copilot/skills/timewarrior-efficient-entry".source = "${cfg.package}/skills/timewarrior-efficient-entry";
    };
